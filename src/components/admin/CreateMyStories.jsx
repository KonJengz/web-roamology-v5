...
function CreateMyStories() {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      await actionCreatePost(formData);
      fetchUser();
      toast.success("Create My Story success");
      document.getElementById("modal_create_my_stories").close();
      reset();
      setFiles([]);
    } catch (error) {
      console.log(error);
...
export default CreateMyStories;
